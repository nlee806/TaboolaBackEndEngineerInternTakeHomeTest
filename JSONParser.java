...
public class JSONParser{
	...
	public static Map<String,Object> parse(String json) throws Exception{
		...
		for(int a=0;a<json.length();a++){
			...
			if(containerBracket == true && (a>indexClosedBrace)){
				...
				if(currentChar == ',' || (currentChar=='}')){//(a==json.length()-1)){//(currentChar=='}')){
						addNewKeyValue = true;
						/*if(json.charAt(a-1)!=',' && json.charAt(a-1)!='}'){
							addNewKeyValue = true;
						}*/
					}
				}
	...
	**/
	public static void main(String[] args) throws Exception{
		...
		String exampleString = "{\"testNum\": -59832.45e10, \"testbool\": false, \"debug\" : \"on\",\"window\" : {\"title\" : \"sample\",\"size\": 500}, \"testnull\":null, \"testBraces\":{\"test1\":\"test1value\", \"test2\":{\"test2a\":{\"test2aa\":\"test2aaresult\"}}, \"test3\": \"(kk}-> pe \"}}";
