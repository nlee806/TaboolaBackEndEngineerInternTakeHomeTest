...
public class JSONParser{
	...
	**/
	public static Map<String,Object> parse(String json){
		...
		for(int a=0;a<json.length();a++){
			...
			if(addNewKeyValue == true){
				value = stringWriter; //TODO INCORRECT
	...
	/**
		nestedHashMap()
		Handles nested hash maps, allows for recursion.
	**/
	//public static LinkedHashMap<String, Object> nestedHashMap(){
	...
	**/
	public static void main(String[] args){
		...
		//assert output.get("window").get("title").equals("sample");
		//assert output.get("window").get("size");.equals(500);
