...
public class JSONParser{
		...
		for(int a=0;a<json.length();a++){
			...
			if(addNewKeyValue == true){
				if(isNumber == true){
					...
					System.out.println("AddNewKeyValue Else "+stringWriter);
					value = stringWriter;
				}
	...
	**/
	public static void main(String[] args) throws Exception{
		...
		String exampleString = "{\"testNum\": -59832.45e10, \"testbool\": false, \"debug\" : \"on\",\"window\" : {\"title\" : \"sample\",\"size\": 500}, \"testnull\":null, \"testBraces\":{\"test1\":\"test1value\", \"test2\":{}, \"test3\": \"(kk}-> pe \"}}";
